document.addEventListener('DOMContentLoaded', function () {
    ...
    const projects = [
        ...
        {
            title: 'VLSI Internship – Monk Tech',
            description: 'Work, learnings, and practical tasks completed during VLSI Internship at Monk Tech, Rajkot. Covers VLSI fundamentals, digital circuit design, CMOS concepts, RTL design, and EDA tools.',
            tags: ['VLSI', 'Verilog', 'Digital Electronics', 'CMOS', 'RTL Design', 'EDA Tools'],
            codeLink: 'https://github.com/Parth-Makwana06/MONK-Tech-Internship.git',
            image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=600'
        },
        {
            title: 'IOT Based  Cow Monitoring System',
            description: 'Real-time monitoring of cow health parameters like temperature, movement, and location using IoT sensors with cloud-based dashboard.',
            tags: ['Arduino', 'IoT', 'Sensors'],
            codeLink: 'https://github.com/Parth-Makwana06/IoT-Based-Cow-Monitoring-System-.git',
            image: 'https://images.openai.com/static-rsc-3/evpBGfFpB8_uwtPBzfvE6k_MqMFECQOzD3y02GwAC9j0Lo2BXf35tRTilApnWGk2MF9uNbCvncbdJ1v9zvSANanJayRByBrSI5HaMBsyjgg?purpose=fullsize'
        }
    ];
    ...
    function renderProjects() {
        ...
        viewAllBtn.textContent = showAll ? 'Show Less' : 'View All Projects';
    }
    ...
    const skills = [
        ...
        { name: 'IoT', icon: 'fas fa-wifi', color: '#FF6F61' },
        { name: 'verilog', icon: 'fas fa-code-branch', color: '#F0DB4F' },
        { name: 'C/C++', icon: 'fas fa-c', color: '#A8B9CC' },
        { name: 'GitHub', icon: 'fab fa-github', color: '#181717' },
        { name: 'VLSI', icon: 'fas fa-microchip', color: '#FF5722' },
        { name: 'semiconductor', icon: 'fas fa-industry', color: '#9C27B0' },
    ...
    const experienceData = [
        {
            position: 'VLSI Intern',
            company: 'Monk Tech, Rajkot (Gujarat)',
            duration: 'Dec 25, 2025 – Apr 29, 2026',
            description: 'Completed a VLSI Internship at <b>Monk Tech, Rajkot</b>. Gained practical knowledge of VLSI fundamentals, digital circuit design, CMOS concepts, and RTL design basics. Got hands-on exposure to EDA tools and VLSI workflows, bridging the gap between theory and real-world semiconductor implementation.',
            skills: ['VLSI', 'Digital Electronics', 'RTL Design', 'CMOS', 'EDA Tools', 'Verilog'],
        },
        {
            position: 'Artificial Intelligence Intern',
            company: 'Codec Technologies India',
            duration: 'Aug 2025 – Sep 2025',
            description: 'Completed an internship in Artificial Intelligence focusing on core AI concepts, problem-solving techniques, and practical exposure to AI tools and workflows. Gained hands-on experience in understanding AI fundamentals and applying them to real-world scenarios.',
            skills: ['Artificial Intelligence', 'Machine Learning Basics', 'Problem Solving', 'Python', 'AI Tools']
        },
        {
        ...
        {
            position: 'Generative AI Mastermind',
            company: 'Online Certification',
            duration: '2025',
            description: 'Gained practical knowledge of Generative AI, prompt engineering, and AI-driven problem solving.',
    ...
    const viewAllExperienceBtn = document.getElementById('viewAllExperienceBtn');
    ...
    function renderExperience() {
        ...
        const list = showAllExperience
            ? experienceData
            : experienceData.slice(0, 3); // 👈 start ma khali 2 experience
        ...
        list.forEach((exp, index) => {
            ...
            expItem.innerHTML = `
                <div class="experience-content">
                    ${exp.image ? `<img src="${exp.image}" alt="${exp.company}" class="experience-img">` : ''}
                    <h3>${exp.position}</h3>
        ...
        viewAllExperienceBtn.textContent =
